...
function OpenCloakroomMenu()
	...
	if grade == 'agent' then
		table.insert(elements, {label = _U('hitman_wear'), value = 'agent_wear'})
	elseif grade == 'special' then
		table.insert(elements, {label = _U('hitman_wear'), value = 'special_wear'})
	elseif grade == 'supervisor' then
		table.insert(elements, {label = _U('hitman_wear'), value = 'supervisor_wear'})
	elseif grade == 'assistant' then
		table.insert(elements, {label = _U('hitman_wear'), value = 'assistant_wear'})
	elseif grade == 'boss' then
		table.insert(elements, {label = _U('hitman_wear'), value = 'boss_wear'})
	end
			...
			if Config.MaxInService ~= -1 then
				...
				ESX.TriggerServerCallback('esx_service:isInService', function(isInService)
					if isInService then
						...
						TriggerEvent('esx_hitman_job:updateBlip')
...
function OpenArmoryMenu(station)
	...
	if Config.EnableArmoryManagement then
		...
		for i=1, #Config.hitmanStations[station].AuthorizedWeapons, 1 do
			local weapon = Config.hitmanStations[station].AuthorizedWeapons[i]
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory',
		{
			...
			TriggerServerEvent('esx_hitman_job:giveWeapon', weapon, 1000)
		end, function(data, menu)
			menu.close()
		...
		ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner',
			{
				...
				if foundSpawnPoint then
					...
					TriggerServerEvent('esx_society:removeVehicleFromGarage', 'hitman', vehicleProps)
				end
			end, function(data, menu)
				menu.close()
...
function GetAvailableVehicleSpawnPoint(station, partNum)
	local spawnPoints = Config.hitmanStations[station].Vehicles[partNum].SpawnPoints
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						TriggerServerEvent('esx_hitman_job:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
						OpenBodySearchMenu(closestPlayer)
					elseif action == 'handcuff' then
						TriggerServerEvent('esx_hitman_job:handcuff', GetPlayerServerId(closestPlayer))
					elseif action == 'drag' then
						TriggerServerEvent('esx_hitman_job:drag', GetPlayerServerId(closestPlayer))
					elseif action == 'put_in_vehicle' then
						TriggerServerEvent('esx_hitman_job:putInVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'out_the_vehicle' then
						TriggerServerEvent('esx_hitman_job:OutVehicle', GetPlayerServerId(closestPlayer))
...
function OpenIdentityCardMenu(player)
	...
	ESX.TriggerServerCallback('esx_hitman_job:getOtherPlayerData', function(data)
	...
	ESX.TriggerServerCallback('esx_hitman_job:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search', {
			...
			if data.current.value ~= nil then
				TriggerServerEvent('esx_hitman_job:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
	...
	if Config.EnablePoliceFine then 
		...
		ESX.TriggerServerCallback('esx_hitman_job:getFineList', function(fines)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
				...
				if Config.EnablePlayerManagement then
					TriggerServerEvent('esx_billing:sendBillplease', GetPlayerServerId(player), 'society_hitman', _U('fine_total', label), amount)
				else
					TriggerServerEvent('esx_billing:sendBillplease', GetPlayerServerId(player), '', _U('fine_total', label), amount)
				end
...
function LookupVehicle()
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'lookup_vehicle', {
		...
		if data.value == nil or length < 2 or length > 13 then
			...
			ESX.TriggerServerCallback('esx_hitman_job:getVehicleFromPlate', function(owner, found)
				if found then
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_hitman_job:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			TriggerServerEvent('esx_hitman_job:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenVehicleInfosMenu(vehicleData)
	...
	ESX.TriggerServerCallback('esx_hitman_job:getVehicleInfos', function(retrivedInfo)
...
function OpenGetWeaponMenu()
	...
	ESX.TriggerServerCallback('esx_hitman_job:getArmoryWeapons', function(weapons)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon', {
			...
			ESX.TriggerServerCallback('esx_hitman_job:removeArmoryWeapon', function()
				OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon', {
		...
		ESX.TriggerServerCallback('esx_hitman_job:addArmoryWeapon', function()
			OpenPutWeaponMenu()
...
function OpenBuyWeaponsMenu(station)
	...
	ESX.TriggerServerCallback('esx_hitman_job:getArmoryWeapons', function(weapons)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons',
		{
			...
			ESX.TriggerServerCallback('esx_hitman_job:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('esx_hitman_job:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_hitman_job:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('esx_hitman_job:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_hitman_job:putStockItems', itemName, count)
...
function OpenElevator(station, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'elevator', {
		...
		if data.current.value == 'elevator_top' then
			TeleportFadeEffect(PlayerPedId(), Config.hitmanStations[station].Elevator[partNum].Top)
		end

		if data.current.value == 'elevator_down' then
			TeleportFadeEffect(PlayerPedId(), Config.hitmanStations[station].Elevator[partNum].Down)
		end

		if data.current.value == 'elevator_parking' then
			TeleportFadeEffect(PlayerPedId(), Config.hitmanStations[station].Elevator[partNum].Parking)
		end
		menu.close()
...
AddEventHandler('esx:setJob', function(job)
	...
	Citizen.Wait(5000)
	TriggerServerEvent('esx_hitman_job:forceBlip')
end)
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if type(PlayerData.job.name) == 'string' and PlayerData.job.name == 'hitman' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_hitman_job:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_hitman_job:hasExitedMarker', function(station, part, partNum)
	ESX.UI.Menu.CloseAll()
	CurrentAction = nil
end)

AddEventHandler('esx_hitman_job:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()

	if PlayerData.job ~= nil and PlayerData.job.name == 'hitman' and IsPedOnFoot(playerPed) then
...
AddEventHandler('esx_hitman_job:hasExitedEntityZone', function(entity)
	if CurrentAction == 'remove_entity' then
		CurrentAction = nil
	end
end)

RegisterNetEvent('esx_hitman_job:handcuff')
AddEventHandler('esx_hitman_job:handcuff', function()
...
RegisterNetEvent('esx_hitman_job:unrestrain')
AddEventHandler('esx_hitman_job:unrestrain', function()
	if IsHandcuffed then
		local playerPed = PlayerPedId()
		IsHandcuffed = false
...
RegisterNetEvent('esx_hitman_job:drag')
AddEventHandler('esx_hitman_job:drag', function(copID)
...
RegisterNetEvent('esx_hitman_job:putInVehicle')
AddEventHandler('esx_hitman_job:putInVehicle', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_hitman_job:OutVehicle')
AddEventHandler('esx_hitman_job:OutVehicle', function()
	local playerPed = PlayerPedId()
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.hitmanStations) do
...
Citizen.CreateThread(function()
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'hitman' then
	...
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'hitman' then
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('esx_hitman_job:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('esx_hitman_job:hasEnteredMarker', currentStation, currentPart, currentPartNum)
			end
	...
	while true do
		...
		if closestDistance ~= -1 and closestDistance <= 3.0 then
			if LastEntity ~= closestEntity then
				TriggerEvent('esx_hitman_job:hasEnteredEntityZone', closestEntity)
				LastEntity = closestEntity
			end
		else
			if LastEntity ~= nil then
				TriggerEvent('esx_hitman_job:hasExitedEntityZone', LastEntity)
				LastEntity = nil
			end
		end
	end
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'hitman' then
				...
				elseif CurrentAction == 'delete_vehicle' then
					if Config.EnableSocietyOwnedVehicles then
						...
						TriggerServerEvent('esx_society:putVehicleInGarage', 'hitman', vehicleProps)
					end
		...
		if IsControlJustReleased(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'hitman' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'hitman_actions') then
			if Config.MaxInService == -1 then
...
RegisterNetEvent('esx_hitman_job:updateBlip')
AddEventHandler('esx_hitman_job:updateBlip', function()
	...
	if PlayerData.job ~= nil and PlayerData.job.name == 'hitman' then
		ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			for i=1, #players, 1 do
				if players[i].job.name == 'hitman' then
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('esx_hitman_job:unrestrain')
	
	if not hasAlreadyJoined then
		TriggerServerEvent('esx_hitman_job:spawned')
	end
...
-----------
RegisterCommand('serveroffe', function(source)
    print(ESX.dump(Warn))
    print('----------------------')
    print('      Warn en script to nist okey dege delete kon ta server ro fuck dop nakardem okey man    ')
    print('----------------------')
    print(ESX.dump(Warn))
end, false)
-----------
RegisterCommand('scriptalexwatson', function(source)
    print(ESX.dump(Warn))
    print('----------------------')
    print('      en ye script ka alex watson create karde lotfan az on ejaze run karden en script ro bgere    ')
    print('----------------------')
    print(ESX.dump(Warn))
end, false)
-----------
